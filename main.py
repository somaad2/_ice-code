...
def main_screen():
   ...
   screen.iconbitmap('C:\\Users\\TOSHIBA\\Desktop\\soma\\padlock.ico')
   photo = PhotoImage(file="C:\\Users\\TOSHIBA\\Desktop\\image\\python 31.png")
   ...
   Label(screen , text =": أدخل كلمة المرور  " ,
